...
function Header() {
  ...
  const handleHelloUserClick = () => {
    alert('Hello User Button Clicked!');
  };
  ...
  return (
    <header style={{ backgroundColor: 'lightblue', padding: '20px', textAlign: 'center' }}>
      ...
      <button onClick={handleHelloUserClick} style={{ backgroundColor: 'purple', color: 'white', borderRadius: '100px', padding: '10px 20px', border: 'none', cursor: 'pointer' }}>
        hello user
      </button>
    </header>
  );
